...
Node.prototype.execWithin = Node.prototype.allWithin = function(queryExecutor) {
  return queryExecutor.query(this.toQuery()).then(result => result.rows);
}

Node.prototype.getWithin = function(queryExecutor) {
  return queryExecutor.query(this.toQuery()).then(function(result) {
